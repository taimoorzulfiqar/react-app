...
const LoadFormSettlementTwoPage = () => {
  const navigate = useNavigate();

  function handleNavigate225() {
    navigate("/loadformsettlement");
  }
  function handleNavigate231() {
    navigate("/successloadform");
  }
  function handleNavigate232() {
    navigate("/maindashboard");
  }
  function handleNavigate233() {
    navigate("/stores");
  }
  function handleNavigate234() {
    navigate("/mainloadform");
  }
  function handleNavigate235() {
    navigate("/recoveries");
  }
    ...
    <>
      <div className="bg-white_A700 flex flex-col font-poppins justify-end mx-[auto] sm:pr-[15px] md:pr-[44px] pr-[65px] shadow-bs3 w-[100%]">
        <div className="flex flex-row md:flex-wrap sm:flex-wrap items-center max-w-[1375px] ml-[auto] mr-[auto] sm:pl-[15px] sm:pr-[15px] w-[100%]">
          ...
          <div className="flex flex-col md:ml-[17px] ml-[26px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[77%]">
            ...
            <div className="flex flex-row md:flex-wrap sm:flex-wrap items-center ml-[133px] md:ml-[91px] sm:mt-[20px] md:mt-[26px] mt-[38px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[51%]">
              ...
              <Text
                className="font-semibold ml-[11px] sm:ml-[5px] md:ml-[7px] text-black_900 w-[auto]"
                variant="body3"
              >
                Deliveryman Expense
              </Text>
              <Text
                className="font-semibold mb-[1px] sm:ml-[11px] md:ml-[15px] ml-[22px] text-black_900 w-[auto]"
                variant="body3"
              >
                Amount Collected
              </Text>
            </div>
            <div className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-end ml-[auto] sm:mt-[3px] md:mt-[4px] mt-[6px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[88%]">
              <Stack className="font-poppins h-[24px] relative sm:w-[100%] w-[59%]">
                <Line className="absolute bg-black_900 h-[2px] top-[4%] w-[100%]" />
                <div className="absolute flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between left-[9%] sm:mx-[0] sm:px-[0] right-[5%] sm:w-[100%] w-[86%]">
                  <Text
              ...
              <Button
                className="common-pointer cursor-pointer font-bold font-urbanist min-w-[24%] md:ml-[110px] ml-[160px] sm:ml-[85px] mt-[12px] sm:mt-[6px] md:mt-[8px] text-[16px] text-center text-white_A700 tracking-ls020000000298023224 md:tracking-ls1 sm:tracking-ls1 w-[max-content]"
                onClick={handleNavigate231}
...
export default LoadFormSettlementTwoPage;
