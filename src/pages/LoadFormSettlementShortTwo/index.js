...
const LoadFormSettlementShortTwoPage = () => {
  ...
  return (
    <>
      <div className="bg-white_A700 flex flex-col font-poppins justify-end mx-[auto] md:pr-[143px] sm:pr-[15px] pr-[209px] shadow-bs3 w-[100%]">
        <div className="flex flex-row md:flex-wrap sm:flex-wrap items-center max-w-[1231px] ml-[auto] mr-[auto] sm:pl-[15px] sm:pr-[15px] w-[100%]">
          ...
          <div className="flex flex-col md:ml-[26px] ml-[39px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[85%]">
            ...
            <div className="flex flex-row md:flex-wrap sm:flex-wrap items-center ml-[133px] md:ml-[91px] sm:mt-[20px] md:mt-[26px] mt-[38px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[51%]">
              <Text
                className="font-semibold mb-[1px] text-black_900 w-[auto]"
                variant="body3"
              >
              ...
              <Text
                className="font-semibold ml-[14px] sm:ml-[7px] md:ml-[9px] text-black_900 w-[auto]"
                variant="body3"
              >
                Deliveryman Expense
              </Text>
              <Text
                className="font-semibold mb-[1px] sm:ml-[10px] md:ml-[13px] ml-[19px] text-black_900 w-[auto]"
                variant="body3"
              >
                Amount Collected
              </Text>
            </div>
            <div className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-end ml-[auto] sm:mt-[3px] md:mt-[4px] mt-[6px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[87%]">
              <Stack className="font-poppins h-[24px] relative sm:w-[100%] w-[61%]">
                <Line className="absolute bg-black_900 h-[2px] top-[4%] w-[100%]" />
                <div className="absolute flex flex-row md:flex-wrap sm:flex-wrap items-start left-[10%] sm:mx-[0] sm:px-[0] right-[8%] sm:w-[100%] w-[82%]">
                  <Text
                  ...
                  <Line className="bg-black_900 sm:h-[13px] md:h-[17px] h-[24px] sm:ml-[20px] md:ml-[26px] ml-[39px] w-[2px]" />
                  <Text
                    className="font-semibold sm:ml-[35px] md:ml-[45px] ml-[66px] mt-[2px] text-black_900 w-[auto]"
                    variant="body3"
                  >
                    PKR 5,000
                  </Text>
                  <Line className="bg-black_900 sm:h-[13px] md:h-[17px] h-[24px] sm:ml-[26px] md:ml-[33px] ml-[49px] w-[2px]" />
                  <Text
                    className="font-semibold sm:ml-[11px] md:ml-[15px] ml-[22px] mt-[2px] text-black_900 w-[auto]"
                    variant="body3"
                  >
                    PKR 55,000
                  </Text>
              ...
              <Button
                className="common-pointer cursor-pointer font-bold font-urbanist min-w-[24%] ml-[145px] sm:ml-[77px] md:ml-[99px] mt-[12px] sm:mt-[6px] md:mt-[8px] text-[16px] text-center text-white_A700 tracking-ls020000000298023224 md:tracking-ls1 sm:tracking-ls1 w-[max-content]"
...
export default LoadFormSettlementShortTwoPage;
